...
* Последующий вызов [`PayOrder`](https://iiko.github.io/front.api.sdk/v9/html/Overload_Resto_Front_Api_IOperationService_PayOrder.htm) приводит к закрытию заказа
* Для уже фискализированных банкетов вызов [`PayOrder`](https://iiko.github.io/front.api.sdk/v9/html/Overload_Resto_Front_Api_IOperationService_PayOrder.htm) успешно закрывает заказ
