...
При печати фискального чека до оплаты, заказ перейдет в нередактируемое состояние (статус [`Bill`](https://iiko.github.io/front.api.sdk/v9/html/T_Resto_Front_Api_Data_Orders_OrderStatus.htm)), однако проведение оплат происходить не будет.
