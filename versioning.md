...
| V6         | Стабильная        | 7.0    |          |
| V7Preview1 | Актуальная        | 7.1    |          |
| V7         | Разрабатываемая   |        |          |


\* - Версия V6Preview4 была экспериментальной, она выпущена в начале цикла разработки iikoRMS 6.4. Кроме того, были пропущены V6Preview6 и V6Preview7, вместо них сразу вышла LTS-версия V6.
