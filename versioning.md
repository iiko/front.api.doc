...
<svg height="640" width="816">
  ...
  <g>
    ...
    <text x="546" y="520" font-size="80%">8.2</text>
    <text x="570" y="520" font-size="80%">8.3</text>
    <text x="592" y="520" font-size="80%">8.4</text>    
  </g>
  <g>
    ...
    <rect x="456" y="290" fill="darkblue" height="10" width="136" />
...
| V7Preview7 | Устаревшая        | 7.7              | 8.3<sup>3</sup>      |
| V7         | Стабильная        | 7.9              |          |
...
<sup>3</sup> Поддержка версии V7Preview7 была продлена до 8.3 включительно из-за проблем с автообновлением плагинов с V7Preview7 на V7.
