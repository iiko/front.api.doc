...
| V8Preview2 | Устаревшая        | 8.1              | 8.3      |
| V8Preview3 | Актуальная        | 8.2              | 8.4      |
| V8         | Разрабатываемая   |                  |          |
...
<sup>3</sup> Поддержка версии V7Preview7 была продлена до 8.2 включительно из-за проблем с автообновлением плагинов с V7Preview7 на V7.
